...
func Sign(prvKey string, data []byte) (string, error) {
...
func TestDciClaim(t *testing.T) {
	...
	authorJson, _ := json.Marshal(dci.AuthorList)
	...
	signature, _ := Sign(dci.ProposerSk, []byte(signStr))
